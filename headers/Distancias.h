...
double distancia(double lat1, double lon1, double lat2, double lon2); /** Função que calcula a distância entre dois pontos
...
double distancia(pair<double, double> coord1, pair<double, double> coord2); /** Função que calcula a distância entre dois pontos
